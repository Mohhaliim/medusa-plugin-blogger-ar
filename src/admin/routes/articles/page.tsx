...
import ToolBar from "../../components/articles/tool_bar";
...
const ArticlePage = () => {
    ...
    const { data, isLoading } = useAdminCustomQuery(
        "/blog/articles?" + objectToQueryString(
            {
                select: ["id", "thumbnail_image", "body_images" , "title", "title_ar", "subtitle", "subtitle_ar", "created_at"],
    ...
    */
    ...
    useEffect(() => {
        if (JSON.stringify(filtersSort) != "{}" || searchText != "") {
    ...
    }, [JSON.stringify(filtersSort), searchText])
    ...
    return (
        <div className="flex flex-col gap-5 items-center break-words relative mb-12">
            <ToolBar setSearchText={setSearchText} setFiltersSort={setFiltersSort} setCategoryVisible={setCategoryVisible} categoryVisible={categoryVisible}/>
            {
