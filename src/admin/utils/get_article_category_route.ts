...
export const getArticleCategoriesRoute = async (req: MedusaRequest, res: MedusaResponse) => {
    ...
    try {
        ...
        const {englishCategories, arabicCategories} = separateBlogsScript(categories)
