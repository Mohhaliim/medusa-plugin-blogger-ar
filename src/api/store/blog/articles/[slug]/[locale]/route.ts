...
export const GET = async (req: MedusaRequest, res: MedusaResponse) => {
    try {
        ...
        const select = ["id", "author","tags","seo_title","seo_keywords","url_slug","seo_description","thumbnail_image", "thumbnail_alt","title","subtitle","body","body_images","created_at",]
        const selectAr = ["id", "author_ar","tags_ar","seo_title_ar","seo_keywords_ar","url_slug_ar","seo_description_ar","thumbnail_image", "thumbnail_alt_ar","title_ar","subtitle_ar","body_ar","body_images_ar","created_at",]
        ...
        let article = await articleRepo.findOne({
            ...
            where:[
                { id: sanitizedSlug.includes("blog_article_") ? sanitizedSlug : `blog_article_${sanitizedSlug}` },
